...
const modernLivingRoom = {
  ...
  furniture: () => [
    f('l-couch', [-4.5, 0, 3.5], [-3.131, 0, -3.134]),
    f('rounded-coffee-table', [0.25, 0.5, -1], [0, 1.105, 0]),
    f('tv', [0, 1.75, -4.9]),
    f('shelf-large', [6.5, 0, -3.5], [0, -1.571, 0], [0.65, 0.65, 0.65]),
    f('rug', [0.25, 0.25, -0.75], [0, 1.571, 0], [2.65, 2.65, 2.65]),
    f('houseplant-tall', [0, 0.5, -4.75], [0, 0, 0], [0.9, 0.9, 0.9]),
    f('houseplant-small', [0.25, 0.75, -1], [0, 0, 0], [1.1, 1.1, 1.1]),
    f('light-floor', [3.25, 1.5, 3.25]),
    f('light-chandelier', [0, 3, -0.5]),
    f('curtains-double', [3, 0, -4.9], [0, 0, 0], [0.6, 0.6, 0.6]),
    f('table-round-small', [3.25, 0.25, 3.5], [0, -1.57, 0]),
    f('chair', [4.75, 0, 3.25], [0, -0.785, 0]),
    f('painting-canvas', [1.5, 0.75, 4], [0, -0.785, 0]),
    f('computer-desk', [-2.25, 0.25, 1.25], [0, 0, 0], [1.6, 1.6, 1.6]),
    f('houseplant-small', [-6.5, 0, -4.5]),
    f('houseplant-fern', [-6.25, 0, -0.5], [0, 0, 0], [1.35, 1.35, 1.35]),
    f('wood-kitchen-chair', [0, 0.25, -4.75], [0, 0, 0], [1.1, 1.1, 1.1]),
    f('lamp', [0.75, 0.5, -4.75], [0, 0, 0], [0.85, 0.85, 0.85]),
    f('lamp', [-0.75, 0.5, -4.75], [0, 0, 0], [0.85, 0.85, 0.85]),
    f('houseplant-small', [6.25, 0, 2.75], [0, 0, 0], [1.1, 1.1, 1.1]),
    f('houseplant-small', [6.25, 0, 4], [0, 0, 0], [1.1, 1.1, 1.1]),
  ],
  lightPreset: 'day',
};
